...
# define printf(FORMAT_STR, ...) printf(XorStr(FORMAT_STR), ##__VA_ARGS__);
# define snprintf(BUFFER, BUFFER_SIZE, FORMAT_STR, ...) snprintf(BUFFER, BUFFER_SIZE, XorStr(FORMAT_STR), ##__VA_ARGS__);
